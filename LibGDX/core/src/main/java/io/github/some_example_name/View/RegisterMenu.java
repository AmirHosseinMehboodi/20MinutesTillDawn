...
public class RegisterMenu implements Screen {
    ...
    public RegisterMenu() {
        ...
        this.securityQuestion = new TextField("answer", skin);

        this.playButton = new TextButton("register", skin);
        this.playAsGuestButton = new TextButton("play as guest", skin);

        this.questions = new SelectBox<>(skin);
        this.questions.setItems("name of your pet", "name of your celebrity crush",
            "your favourite tank in WW2", "name of your classmate you hate the most");
    ...
    public void show() {
        ...
        username.setPosition(810, 520);
        username.setSize(300,80);
        stage.addActor(username);

        password.setPosition(810, 430);
        password.setSize(300,80);
        stage.addActor(password);


        securityQuestion.setPosition(810, 340);
        securityQuestion.setSize(200,80);
        stage.addActor(securityQuestion);

        questions.setSize(100,80);
        questions.setPosition(1010, 340);
        stage.addActor(questions);

        playButton.setPosition(840, 180);
        stage.addActor(playButton);

        playAsGuestButton.setPosition(785, 60);
        stage.addActor(playAsGuestButton);
    ...
    public void render(float v) {
        ...
        String message = RegisterMenuController.handleButton(this);
